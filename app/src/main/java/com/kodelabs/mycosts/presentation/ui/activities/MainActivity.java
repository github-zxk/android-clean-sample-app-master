...
import com.kodelabs.mycosts.sync.SyncService;
...
public class MainActivity extends AppCompatActivity implements MainPresenter.View
{
   ...
   private void init()
   {
      ...
      com.kodelabs.mycosts.network.services.SyncService syncService = RestClient.getService(com.kodelabs.mycosts.network.services.SyncService.class);
      syncService.getBanner(12).enqueue(new Callback<Object>()
      {
         @Override
